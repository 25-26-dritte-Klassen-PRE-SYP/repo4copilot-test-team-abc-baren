import type { BlackjackGameInsert } from '../models/blackjack.model'
import { createBlackjackRepository } from '../models/blackjack.model'

export type BlackjackGameStatus = 'PLAYER_TURN' | 'DEALER_TURN' | 'FINISHED'
export type BlackjackResult = 'WIN' | 'LOSE' | 'DRAW'
